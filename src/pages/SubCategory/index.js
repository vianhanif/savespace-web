...
import SubCategoriesContainer from '../../_containers/SubCategories'
...
class SubCategory extends Component {
  ...
  componentWillMount() {
    this.props.dispatch(appActions.setTitle('Sub Category'))
  }
     ...
     (
      <Fragment>
        ...
        <Container gutter={GUTTER_TYPE.BOTH}>
          <label className="header">Pick sub-activity</label>
