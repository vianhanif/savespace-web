...
class RegistHostStep7 extends Component {
  state = {
    fetched: true
  };
    ...
    return this.state.fetched ? (
      <Fragment>
        ...
        <Container gutter={GUTTER_TYPE.BOTH}>
          <div className="regist-step7-container">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RegistHostStep7));
